...
Java_com_picsart_studio_gifencoder_GifInfoHandle_openFile(JNIEnv *env, jclass __unused class,
...
__unused JNIEXPORT jobject JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_openByteArray(JNIEnv *env, jclass __unused class,
...
__unused JNIEXPORT jobject JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_openDirectByteBuffer(JNIEnv *env,
...
__unused JNIEXPORT jobject JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_openStream(JNIEnv *env, jclass __unused class,
...
__unused JNIEXPORT jobject JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_openFd(JNIEnv *env, jclass __unused handleClass,
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_free(JNIEnv *env, jclass __unused handleClass, jlong gifInfo) {
