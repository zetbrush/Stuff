...
Java_com_picsart_studio_gifencoder_GifInfoHandle_getComment(JNIEnv *env, jclass __unused handleClass,
                                                   jlong gifInfo) {
    if (gifInfo == 0) {
        return NULL;
    }
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_isAnimationCompleted(JNIEnv __unused *env, jclass __unused handleClass,
                                                             jlong gifInfo) {
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_getLoopCount(JNIEnv __unused *env, jclass __unused handleClass,
                                                     jlong gifInfo) {
    if (gifInfo == 0)
        return 0;
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_setLoopCount(JNIEnv __unused *env, jclass __unused handleClass,
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getDuration(JNIEnv *__unused  env, jclass __unused handleClass,
                                                    jlong gifInfo) {
    if (gifInfo == 0) {
        return 0;
    }
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_getSourceLength(JNIEnv __unused *env, jclass __unused handleClass,
                                                        jlong gifInfo) {
    if (gifInfo == 0) {
        return -1;
    }
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getCurrentPosition(JNIEnv *__unused env,
...
__unused JNIEXPORT jlong JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getAllocationByteCount(JNIEnv *__unused  env,
                                                               jclass __unused handleClass, jlong gifInfo) {
    if (gifInfo == 0) {
        return 0;
    }
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getNativeErrorCode(JNIEnv *__unused  env,
                                                           jclass __unused handleClass, jlong gifInfo) {
    if (gifInfo == 0)
        return 0;
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getCurrentLoop(JNIEnv __unused *env, jclass __unused handleClass,
                                                       jlong gifInfo) {
    if (gifInfo == 0)
        return 0;
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getCurrentFrameIndex(JNIEnv __unused *env, jclass __unused handleClass,
                                                             jlong gifInfo) {
    if (gifInfo == 0)
        return -1;
...
Java_com_picsart_studio_gifencoder_GifInfoHandle_getSavedState(JNIEnv *env, jclass __unused handleClass,
                                                      jlong gifInfo) {
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_restoreSavedState(JNIEnv *env, jclass __unused handleClass,
...
__unused JNIEXPORT jint JNICALL
Java_com_picsart_studio_gifencoder_GifInfoHandle_getFrameDuration(__unused JNIEnv *env, jclass __unused handleClass,
